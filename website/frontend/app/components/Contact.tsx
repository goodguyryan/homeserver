          ...
          {[
            {
              ...
              icon: (
                <svg
                  className="h-12 w-12 transition-all hover:text-cyan"
                  style={{ filter: "none" }}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.filter = "drop-shadow(0 0 8px var(--cyan))";
            ...
            },
            {
              ...
              icon: (
                <svg
                  className="h-12 w-12 transition-all hover:text-pink"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  style={{ filter: "none" }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.filter = "drop-shadow(0 0 8px var(--pink))";
            ...
            },
            {
              ...
              icon: (
                <svg
                  className="h-12 w-12 transition-all hover:text-accent"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  style={{ filter: "none" }}
                  onMouseEnter={(e) => {
